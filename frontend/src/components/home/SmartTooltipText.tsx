...
const DIFFICULT_TERMS: Record<string, string> = {
  ...
  "약물": "질병 치료나 예방을 위해 사용되는 화학 물질",
  "링커": "ADC에서 항체와 약물을 연결하는 화학적 연결고리",
  "암세포": "정상 세포가 변이되어 통제되지 않게 분열하고 증식하는 세포",
  ...
  "항암제": "암세포의 성장을 억제하거나 파괴하는 치료제",
  "표적항암제": "특정 암세포만을 선택적으로 공격하는 항암제",
  "독성": "생체에 해로운 영향을 미치는 성질",
  "정상세포": "정상적인 기능과 구조를 가진 건강한 세포",
  "임상": "환자를 직접 진료하고 치료하는 의료 현장",
  "스마트 약물": "특정 표적에만 작용하여 부작용을 최소화한 지능형 치료제",
  "허가": "의약품이 안전성과 효능을 인정받아 사용 승인을 받는 것",
  ...
  return (
    <Tooltip open={isOpen} onOpenChange={handleOpenChange}>
      <TooltipTrigger asChild>
        <span 
          className="bg-blue-100 text-blue-500 rounded-lg border-[1px] border-blue-200 px-2 py-1 cursor-help hover:bg-blue-200 transition-colors touch-manipulation active:bg-blue-200 inline-block select-none"
          role="button"
          tabIndex={0}
          onClick={handleClick}
